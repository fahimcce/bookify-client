  ...
  return (
    ...
    >
      <div>
        ...
        <div className="py-4 px-3">
          ...
          <div className={`px-2 text-base flex flex-wrap justify-start gap-2`}>
            <Tag className="p-1 px-2 font-semibold font-roboto" color="blue">
              Room No: {roomNo}
            </Tag>
            <Tag className="p-1 px-2 font-semibold font-roboto" color="blue">
              Floor No: {floorNo}
      ...
      <div className="px-4 pt-1 pb-5 flex justify-between gap-3 flex-col sm:flex-row">
        <Link
          to={`/room-details/${_id}`}
          className="w-full text-center bg-blue-500 hover:bg-blue-700 text-white rounded-lg items-center flex justify-center"
        >
          See Details
        </Link>
